                ...
                <div className="container-fluid justify-content-start">
                    ...
                    <div className="collapse navbar-collapse" id="collapsibleNavId">
                        <ul className="navbar-nav me-auto mt-2 mt-lg-0">
                            ...
                            <li className="nav-item" style={{display: (sessionStorage.getItem("type") == undefined || sessionStorage.getItem("type") === "Customer") ? "none" : "block" }}>
                                <Link to="/ulist" className="nav-link fw-bolder" style={{ color: "white" }}>User List</Link>
                            </li>y
                            ...
                            <li className="nav-item" style={{display: (sessionStorage.getItem("type") == undefined || sessionStorage.getItem("type") != "Customer") ? "none" : "block" }}>
                                <Link to="/llist" className="nav-link fw-bolder" style={{ color: "white" }}>Borrowed Book List</Link>
                            </li>
                        </ul>
                    </div>
