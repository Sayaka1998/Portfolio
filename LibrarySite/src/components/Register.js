                        ...
                        <form onSubmit={submitHandle}>
                            <div className="mb-3">
                                <select className="form-select form-select-lg" name="type" value={type} onChange={(e) => setType(e.target.value)}>
                                    ...
                                    <option value="Staff" style={{display:(sessionStorage.getItem("type") == undefined || sessionStorage.getItem("type") === "Customer")? "none" : "block"}}>Staff</option>
                                    <option value="Admin" style={{display:(sessionStorage.getItem("type") === "Admin")? "block" : "none"}}>Admin</option>
                                </select>
                            </div>
